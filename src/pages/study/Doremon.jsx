...
const Doremon = () => {
    ...
    return (
        <div className="page-container" style={{ textAlign: 'center', padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <div style={{ marginBottom: '2rem', padding: '1.5rem', backgroundColor: '#e0f2f1', borderRadius: '15px', textAlign: 'left', width: '100%', maxWidth: '800px', boxShadow: '0 4px 6px rgba(0,0,0,0.05)' }}>
